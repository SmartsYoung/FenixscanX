...
try:
    from scanengine_config import scanengine_temp_dir as temp_dir
except ImportError:
    # alway have something there.
    import tempfile
    temp_dir = tempfile.mkdtemp(prefix='scanengine-resource-cache')
...
and directories used throughout ScanEngine. ScanEngine deals with a lot of these as
...
class Header(object):
    ...
    """
    tool_name = String(help='Name of the tool used such as scanengine-toolkit.')
...
class Resource(object):
    ...
    def to_dict(self, with_timing=False, with_info=False, skinny=False):
        ...
        # see https://github.com/nexB/scanengine-toolkit/issues/1199
...
def get_codebase_cache_dir(temp_dir):
    ...
    prefix = 'scanengine-codebase-' + time2tstamp() + '-'
