...
def load_json(location):
    ...
    # }
    #
    # - JSON output from ScanEngine:
    # look for the "files" field as it is the field
    # that contain everything the tool needs and ignore other fields:
    # For instance,
    # {
    #    "scanengine_notice":"xyz",
    #    "scanengine_version":"xxx",
    #    "files":
    #    [{
    #        "path": "test",
    #        "type": "directory",
    ...
    # }
    #
    # - JSON file that is not produced by scanengine or aboutcode toolkit
    # For instance,
    # {
    #    "path": "test",
    #    "type": "directory",
    ...
    if isinstance(results, list):
        ...
        elif u'scanengine_notice' in results:
