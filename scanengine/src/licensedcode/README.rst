ScanEngine license detection overview and key design elements
===========================================================
...
Some tools use pair-wise comparisons like ScanEngine. But in doing so they usually
...
Because of the progressive matching pipeline used in ScanEngine, sequence alignments
