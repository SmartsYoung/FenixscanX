...
from scanengine_config import scanengine_src_dir
from scanengine_config import SCANENGINE_DEV_MODE
...
def get_index(cache_dir=scanengine_cache_dir, check_consistency=SCANENGINE_DEV_MODE,
              return_value=True):
    """
...
def get_cached_index(cache_dir=scanengine_cache_dir,
                     check_consistency=SCANENGINE_DEV_MODE,
                     # used for testing only
                     timeout=LICENSE_INDEX_LOCK_TIMEOUT,
                     tree_base_dir=scanengine_src_dir,
...
def tree_checksum(tree_base_dir=scanengine_src_dir, _ignored=_ignored_from_hash):
    """
...
def get_license_cache_paths(cache_dir=scanengine_cache_dir):
    """
