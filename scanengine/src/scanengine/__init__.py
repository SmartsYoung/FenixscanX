...
class ScanengineError(Exception):
    """Base exception for scanengine errors"""


class ScanengineCliUsageError(ScanengineError, click.UsageError):
...
info_text = '''
ScanEngine scans code and other files for origin and license.
Visit https://github.com/nexB/scanengine-toolkit/ for support and download.
